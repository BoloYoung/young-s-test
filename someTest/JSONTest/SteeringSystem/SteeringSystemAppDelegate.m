...
@implementation SteeringSystemAppDelegate
...
{
    return (SteeringSystemAppDelegate *)[[UIApplication sharedApplication]delegate];
}
...
//    [mainViewController.loginView LoginButton:sender];
}
@end
